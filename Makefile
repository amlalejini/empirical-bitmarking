...
bitmarking-debug: source/bitmarking.cc
	$(CXX_nat) $(CFLAGS_nat_debug) source/bitmarking.cc -I./source/ -o bitmarking-debug.out

bitmarking: source/bitmarking.cc
	$(CXX_nat) $(CFLAGS_nat) source/bitmarking.cc -I./source/ -o bitmarking.out
